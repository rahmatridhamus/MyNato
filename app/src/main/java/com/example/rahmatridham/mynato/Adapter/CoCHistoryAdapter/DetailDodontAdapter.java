package com.example.rahmatridham.mynato.Adapter.CoCHistoryAdapter;
...
public class DetailDodontAdapter extends BaseExpandableListAdapter {
    Context context;
    List<String> listHeader;
    HashMap<String, List<String>> listChild;

    public DetailDodontAdapter(Context context, List<String> listHeader, HashMap<String, List<String>> listChild) {
