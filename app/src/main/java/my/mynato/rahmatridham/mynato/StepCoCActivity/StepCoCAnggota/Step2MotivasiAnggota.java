...
public class Step2MotivasiAnggota extends AppCompatActivity {
    ...
    private void getMotivasi(String idGroup) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.MAIN_URL + "Cerita_Motivasi/get_data/"+idGroup, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    if (status.equals(String.valueOf(1))) {
                        ...
                        if (!eksisting.optString("id_games", "").equals("")) {
                            ...
                            motivasi.setText(eksisting.optString("title_cerita_motivasi",""));
                            games.setText(eksisting.optString("title_games",""));
                        }
                        dialog.dismiss();
                    } else {
